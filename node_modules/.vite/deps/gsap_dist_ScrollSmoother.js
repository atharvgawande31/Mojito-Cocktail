...
var require_ScrollSmoother = __commonJS({
  "node_modules/gsap/dist/ScrollSmoother.js"(exports, module) {
    (function(global, factory) {
        ...
        function ScrollSmoother2(vars) {
          ...
          var _vars = vars, smoothTouch = _vars.smoothTouch, _onUpdate = _vars.onUpdate, onStop = _vars.onStop, smooth = _vars.smooth, onFocusIn = _vars.onFocusIn, normalizeScroll = _vars.normalizeScroll, wholePixels = _vars.wholePixels, content, wrapper, height, mainST, effects, sections, intervalID, wrapperCSS, contentCSS, paused, pausedNormalizer, recordedRefreshScroll, recordedRefreshScrub, allowUpdates, self2 = this, effectsPrefix = vars.effectsPrefix || "", scrollFunc = ScrollTrigger.getScrollFunc(_win), smoothDuration = ScrollTrigger.isTouch === 1 ? smoothTouch === true ? 0.8 : parseFloat(smoothTouch) || 0 : smooth === 0 || smooth === false ? 0 : parseFloat(smooth) || 0.8, speed = smoothDuration && +vars.speed || 1, currentY = 0, delta = 0, startupPhase = 1, tracker = _getVelocityProp(0), updateVelocity = function updateVelocity2() {
            ...
            var getSpeed = effectValueGetter("speed", speed2, index, el), getLag = effectValueGetter("lag", lag, index, el), startY = gsap.getProperty(el, "y"), cache = el._gsap, ratio, st, autoSpeed, scrub, progressOffset, yOffset, pins = [], initDynamicValues = function initDynamicValues2() {
              ...
              if (autoSpeed) {
                revert();
                var auto = _autoDistance(el, _clamp(0, 1, -self3.start / (self3.end - self3.start)));
                change = auto.change;
                yOffset = auto.offset;
              } else {
                ...
                onUpdate: function onUpdate(self3) {
                  ...
                  if (self3.offset) {
                    if (i) {
                      ...
                      y = startY + extraY + change * ((gsap.utils.clamp(self3.start, self3.end, scrollY) - self3.start - extraY) / (end - self3.start) - progressOffset);
                    }
          ...
          mainST = ScrollTrigger.create({
            ...
            onRefresh: function onRefresh2(self3) {
              ...
              if (!startupPhase) {
                ...
                self3.animation.progress(gsap.utils.clamp(0, 1, recordedRefreshScroll / speed / -self3.end));
              }
      ...
      exports2.ScrollSmoother = ScrollSmoother;
      exports2.default = ScrollSmoother;
...
export default require_ScrollSmoother();
/*! Bundled license information:

gsap/dist/ScrollSmoother.js:
  (*!
  ...
  *)
*/
//# sourceMappingURL=gsap_dist_ScrollSmoother.js.map
